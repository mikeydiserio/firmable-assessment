...
export const Home: React.FC = () => {
	const [filters, setFilters] = useState<IFilters>({
		...
		states: STATES, // All checked by default
		revenueBand: '',
	})
	...
	const filteredAndSortedCompanies = useMemo(() => {
		...
		currentCompanies = currentCompanies.filter((company) => {
			...
			const matchesRevenueBand =
				filters.revenueBand === '' || company.revenueBand === filters.revenueBand

			return (
				matchesIndustry && matchesEmployeeSize && matchesState && matchesRevenueBand
			)
		})
		...
		currentCompanies.sort((a, b) => {
			switch (sortBy) {
				...
				case 'revenue-asc':
					return (
						revenueBandToValue(a.revenueBand) - revenueBandToValue(b.revenueBand)
					)
				case 'revenue-desc':
					return (
						revenueBandToValue(b.revenueBand) - revenueBandToValue(a.revenueBand)
					)
				case 'employees-asc':
